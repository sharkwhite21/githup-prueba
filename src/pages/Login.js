    ...
    <div className='w-full flex flex-col items-center justify-center gap-10 py-20'>
      <div className='w-full flex items-center justify-center gap-10'>
          <div 
            ...
            <span className='text-sm text-gray-900'> Registrate con Google</span>
          </div>
          <button 
      ...
      <div className='w-full flex items-center justify-center gap-10'>
          <div className='text-base w-60 h-12 tracking-wide border-[1px] border-gray-400 rounded-md flex items-center justify-center gap-2 hover:border-blue-600 cursor-pointer duration-300'>
            <img className='w-8' src={githubLogo} alt="google"/>
            <span className='text-sm text-gray-900'> Registrate con GitHub</span>
          </div>
